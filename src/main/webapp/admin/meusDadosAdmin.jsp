    ...
    <div class="card card-cascade narrower d-none" id="collapse-dadosadmin">
        ...
        <form class="py-3 mx-4">
            <div class="form-group">
                ...
                <input type="nome" class="form-control" value="${usuario.nome}" id="exampleInputNome1"
                       placeholder="Nome do cliente">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Endereço de email</label>
                <input type="email" class="form-control" value="${usuario.email}" id="exampleInputEmail1"
